      ...
      {tvMode && (
        <div style={{position:"fixed",inset:0,zIndex:500,display:"flex",flexDirection:"column",padding:"24px 40px",overflow:"hidden",background:TV.animated?undefined:TV.bg,backgroundImage:TV.animated?TV.animBg:undefined,backgroundSize:TV.animated?"400% 400%":undefined,animation:TV.animated?"tvAnim 8s ease infinite":undefined}}>
          ...
          <div style={{textAlign:"center",marginBottom:12,padding:"10px 24px",background:TV.card,border:"1px solid "+TV.border,borderRadius:14,opacity:0.9}}>
            ...
            <div style={{fontSize:"clamp(26px,3.5vw,48px)",color:TV.text,fontStyle:"italic",lineHeight:1.6,maxWidth:1100,margin:"0 auto"}}>"{weeklyVerse.text}"</div>
            <div style={{fontSize:"clamp(20px,2.2vw,32px)",color:TV.muted,fontWeight:700,marginTop:8,letterSpacing:1}}>-- {weeklyVerse.ref}</div>
          </div>
